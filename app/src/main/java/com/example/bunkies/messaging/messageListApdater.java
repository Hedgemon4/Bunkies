...
public class messageListApdater extends RecyclerView.Adapter {
    ...
    public messageListApdater(Context context, List<String> messageList) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_MESSAGE_SENT) {
            ...
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.messaged, parent, false);
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        TextView messageText, timeText, nameText, dateText, chatName;
